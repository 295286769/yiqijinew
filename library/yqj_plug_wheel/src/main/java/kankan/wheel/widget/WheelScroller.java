...
public class WheelScroller {
    ...
    private Handler animationHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            lastScrollY = currY;
            if (delta != 0) {
                listener.onScroll(delta);//每次滚动一点，则让滚轮控件动一点
            }
            ...
            } else if (msg.what == MESSAGE_SCROLL) {//如果滚动结束了，则justify
                justify();
            } else {//滚动完成并且justify之后，停止滚动
                finishScrolling();
            }
        }
    };
