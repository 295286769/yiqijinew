...
public abstract class PullToZoomBase<T extends View> extends LinearLayout implements IPullToZoom<T> {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            //鍒濆鍖栫姸鎬乂iew
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.PullToZoomView11);

            int zoomViewResId = R.layout.list_head_zoom_view;
            if (zoomViewResId > 0) {
                mZoomView = mLayoutInflater.inflate(zoomViewResId, null, false);
            }

            int headerViewResId = R.layout.profile_head_view;
