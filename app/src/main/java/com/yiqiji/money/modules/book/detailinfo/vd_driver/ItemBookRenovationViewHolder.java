...
/**
 * Created by ${huangweishui} on 2017/7/7.
 * address huang.weishui@71dai.com
 */
public class ItemBookRenovationViewHolder extends BaseViewHolder {
    ...
    public ItemBookRenovationViewHolder(View view) {
        super(view);
    ...
    public void bindViewData(BookInfoListMultipItem item) {
        ...
        String billbrand = bookBillItemModel.billbrand;
        if (!TextUtils.isEmpty(billbrand)) {
            stage.setText(billbrand);
        }
    }
