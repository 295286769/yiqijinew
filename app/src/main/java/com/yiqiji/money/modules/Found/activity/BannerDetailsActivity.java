    ...
    private void initView() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                Intent intent = null;
                if (BaseWebView.overrideUrlLoading(BannerDetailsActivity.this,url)) {
                    return true;
                }
                if (url.contains("ziniuapp://money/accountbook/create")) {
                    intent = new Intent(BannerDetailsActivity.this, BooksListActivity.class);
                    startActivity(intent);
                } else if (url.contains("ziniuapp://money/share/invite")) {//邀请
                    ShareUtil.shareMeth(BannerDetailsActivity.this, tv_title, shareText, share_icon, share_medias, LoginConfig.share_url, LoginConfig.share_recommend_friend_title, LoginConfig.share_recommend_friend_text, UIHelper.getDisplayWidth(BannerDetailsActivity.this), true, null, R.drawable.icon);
                    ...
                    String[] mAccountbookid = url.split("/");
                    intent = new Intent(BannerDetailsActivity.this, PaymentDetailsActivity.class);
                    ...
                    Uri uri = Uri.parse("market://details?id=" + BannerDetailsActivity.this.getPackageName());
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
                    try {
                        startActivity(goToMarket);
                    } catch (ActivityNotFoundException e) {
                        Toast.makeText(BannerDetailsActivity.this, "无法启动市场 !", Toast.LENGTH_SHORT).show();
                    }

                } else if (url.contains("ziniuapp://money/feedback")) {
                    intent = new Intent(BannerDetailsActivity.this, QuestionReturnActivity.class);
                    startActivity(intent);
