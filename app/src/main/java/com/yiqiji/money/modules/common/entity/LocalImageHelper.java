...
public class LocalImageHelper {
    ...
    private final MyApplicaction context;
    ...
    public String setCameraImgPath() {
        String foloder = MyApplicaction.getInstence().getCachePath() + "/PostPicture/";
    ...
    // 小图遍历字段
    private static final String[] THUMBNAIL_STORE_IMAGE = {MediaStore.Images.Thumbnails._ID,
    ...
    private LocalImageHelper(MyApplicaction context) {
    ...
    public static void init(MyApplicaction context) {
...
//				}
    ...
    private String getThumbnail(int id, String path) {
        ...
        Cursor cursor = context.getContentResolver().query(MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI,
                THUMBNAIL_STORE_IMAGE, MediaStore.Images.Thumbnails.IMAGE_ID + " = ?", new String[]{id + ""}, null);
