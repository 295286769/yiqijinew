...
public class WeekDayView extends View {
    // 上横线颜色
    private int mTopLineColor = Color.parseColor("#f5f5f5");
    // 下横线颜色
    private int mBottomLineColor = Color.parseColor("#f5f5f5");
    // 周一到周五的颜色
    private int mWeedayColor = getResources().getColor(R.color.secondary_text);
    // 周六、周日的颜色
    private int mWeekendColor = getResources().getColor(R.color.secondary_text);
    // 线的宽度
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawColor(getResources().getColor(R.color.module_line_new));
        int width = getWidth();
