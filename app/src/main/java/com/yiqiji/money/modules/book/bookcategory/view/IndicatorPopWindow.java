...
import com.yiqiji.money.modules.common.view.ReverseTriangleView;
import com.yiqiji.money.modules.common.view.TriangleView;
...
public class IndicatorPopWindow extends PopupWindow {
    ...
    ReverseTriangleView reverseTriangleView;
    int popupWidth;
    int popupHeight;
    ...
    public void initContentView() {
        contentView = View.inflate(mContext, R.layout.pop_base_more_handler_content_layout, null);
        setContentView(contentView);
        setWidth(ViewGroup.LayoutParams.WRAP_CONTENT);
        setHeight(ViewGroup.LayoutParams.WRAP_CONTENT);
        triangleView = (TriangleView) contentView.findViewById(R.id.triangle_view);
        reverseTriangleView=(ReverseTriangleView)contentView.findViewById(R.id.reverse_triangle_view);
    ...
    private View getTriangleView(View targetView){
        if(canShowDrop(targetView)){
            reverseTriangleView.setVisibility(View.GONE);
            return triangleView;
        }
        triangleView.setVisibility(View.GONE);
        return reverseTriangleView;
    }
