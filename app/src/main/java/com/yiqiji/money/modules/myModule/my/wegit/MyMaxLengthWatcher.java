package com.yiqiji.money.modules.myModule.my.wegit;
 ...
 */
public class MyMaxLengthWatcher implements TextWatcher {
    private int maxLen = 0;
    private EditText editText = null;
    private String showToastText;

    public MyMaxLengthWatcher(int maxLen, EditText editText) {
        this.maxLen = maxLen;
        this.editText = editText;
        editText.addTextChangedListener(this);
    }

    public MyMaxLengthWatcher(int maxLen, EditText editText, String showToastText) {
        this.maxLen = maxLen;
        this.editText = editText;
