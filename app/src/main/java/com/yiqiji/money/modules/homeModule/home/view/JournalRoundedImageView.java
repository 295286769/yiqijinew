 ...
 */
public class JournalRoundedImageView extends ImageView {
    public static final String TAG = "SelectableRoundedImageView";

    private int mResource = 0;

    private static final ImageView.ScaleType[] sScaleTypeArray = {ImageView.ScaleType.MATRIX, ImageView.ScaleType.FIT_XY, ImageView.ScaleType.FIT_START,
            ImageView.ScaleType.FIT_CENTER, ImageView.ScaleType.FIT_END, ImageView.ScaleType.CENTER, ImageView.ScaleType.CENTER_CROP, ImageView.ScaleType.CENTER_INSIDE};
    ...
    private float screeWith = 0;

    public JournalRoundedImageView(Context context) {
        super(context);
    }

    public JournalRoundedImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JournalRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        screeWith = XzbUtils.getPhoneScreenintWith((Activity) context);
        ...
        mLeftTopCornerRadius = a
                .getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_left_top_corner_radius, 0);
        mRightTopCornerRadius = a
                .getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_right_top_corner_radius, 0);
        mLeftBottomCornerRadius = a
                .getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_left_bottom_corner_radius, 0);
        mRightBottomCornerRadius = a
                .getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_right_bottom_corner_radius, 0);

        if (mLeftTopCornerRadius < 0.0f || mRightTopCornerRadius < 0.0f || mLeftBottomCornerRadius < 0.0f
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int with = (int) (screeWith / 3.5f);
        int height = (int) (with * 7.1f / 10.8f);
...
//    public static float readPictureDegree(InputStream inputStream) {
//        int degree = 0;
//        try {
...
//        float degrees = readPictureDegree(isBm);
...
//        }
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
        ...
        private void adjustCanvasForBorder(Canvas canvas) {
            ...
            if (ImageView.ScaleType.FIT_START == mScaleType || ImageView.ScaleType.FIT_END == mScaleType || ImageView.ScaleType.FIT_XY == mScaleType
                    || ImageView.ScaleType.FIT_CENTER == mScaleType || ImageView.ScaleType.CENTER_INSIDE == mScaleType
         ...
         *
         * @param colors The desired border color. If it's null, no border will be drawn.
         */
        public void setBorderColor(ColorStateList colors) {
            if (colors == null) {
                mBorderWidth = 0;
