...
public class ClipZoomImageView extends ImageView implements OnScaleGestureListener, OnTouchListener,
    ...
    public Bitmap clip() {
        ...
        draw(canvas);
        return Bitmap.createBitmap(bitmap, mHorizontalPadding, getHVerticalPadding(), getWidth() - 2
                * mHorizontalPadding, (int) ((getWidth() - 2 * mHorizontalPadding) / 1.4f));
    }
    ...
    private int getHVerticalPadding() {
        return (int) (getHeight() / 2 - (getWidth() / 1.3 / 2));
    }
}
