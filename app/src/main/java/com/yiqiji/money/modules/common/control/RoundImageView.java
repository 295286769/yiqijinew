...
public class RoundImageView extends ImageView {
    ...
    // 默认颜色为透明色
    private int defaultColor = getResources().getColor(android.R.color.transparent);
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mBorderThickness = a.getDimensionPixelSize(
                R.styleable.roundedimageview_border_thickness, 1);
        mBorderOutsideColor = a.getColor(
                R.styleable.roundedimageview_border_outside_color, 0xffd5d1c8);
        mBorderInsideColor = a.getColor(
                R.styleable.roundedimageview_border_inside_color, 0xfff7f2e9);
    }
